...
public class CandidateView extends View {
    ...
    public CandidateView(Context paramContext) {
        ...
        this.mColorWhite = resources.getColor(R.color.candidate_white);
        this.mColorBlue = resources.getColor(R.color.candidate_blue);
        this.mColorRed = resources.getColor(R.color.candidate_red);
